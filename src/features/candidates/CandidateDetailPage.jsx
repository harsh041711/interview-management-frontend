...
export default function CandidateDetailPage() {
  ...
  const [actBusy, setActBusy] = useState(null); // 'approve' | 'decline' | 'rescreen' | 'resend' | 'regenerate' | 'select' | 'reject' | 'delete'
    ...
    <div className="candidate-detail">
      ...
      <div className="candidate-detail__actions">
        ...
        {c.status === 'resume_approved' && (
          <Button onClick={() => setSendTestOpen(true)}>Send test</Button>
        )}
